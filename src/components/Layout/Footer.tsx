...
const Footer: React.FC = () => {
  ...
  const quickLinks = [
    ...
    { name: t('nav.features'), path: '/features' },
    { name: t('nav.hospitals'), path: '/hospitals' },
    { name: t('nav.hospitalMap'), path: '/hospital-map' },
    { name: t('nav.outbreakAlerts'), path: '/outbreak-alerts' },
  ];

  const serviceLinks = [
    { name: t('nav.healthCard'), path: '/health-card' },
    { name: t('nav.qrScanner'), path: '/qr-scanner' },
  ...
  const emergencyNumbers = [
    { name: t('footer.emergencyNumbers.ambulance'), number: '108' },
    { name: t('footer.emergencyNumbers.medical'), number: '104' },
    { name: t('footer.emergencyNumbers.covid'), number: '+91 471 2552056' },
    { name: 'Women Helpline', number: '181' },
  ];
    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Services */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-emerald-400">{t('footer.services')}</h3>
            <ul className="space-y-2">
          ...
          {/* Emergency Contacts */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-emerald-400">{t('footer.emergency')}</h3>
            <ul className="space-y-3">
              {emergencyNumbers.map((contact, index) => (
                <motion.li
                  key={contact.number}
