  ...
  const features = [
    {
      url:"/unauthorized",
      icon: Shield,
      title: t("home.features.secureHealth.title"),
      description: t("home.features.secureHealth.description"),
              ...
              <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 mb-12">
                ...
                >
                  ...
                  >
                    ...
                    <span>{t("home.getHealthCard")}</span>
                  </Link>
                </motion.div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16" data-aos="fade-up">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
              Empowering migrant workers with digital health tools, transparent
              healthcare access, and multilingual support across Kerala.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              ...
              >
                  ...
                  <Link to={feature.url} >
                <div
                  className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl mb-6 ${feature.bgColor} group-hover:scale-110 smooth-transition`}
                >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl mb-12 opacity-90">
              Join thousands of migrant workers who trust Aarogyam for their
              healthcare needs. Get started with your digital health card today.
            </p>
