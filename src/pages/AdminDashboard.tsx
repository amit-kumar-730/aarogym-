...
const AdminDashboard: React.FC = () => {
  ...
  const renderOverview = () => (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-6">
        <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-600 dark:text-gray-400 text-sm">Total Migrants</p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-600 dark:text-gray-400 text-sm">Hospitals</p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-600 dark:text-gray-400 text-sm">Active Outbreaks</p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-600 dark:text-gray-400 text-sm">Health Cards</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Disease Outbreaks</h3>
          <ResponsiveContainer width="100%" height={300}>
            <RechartsPieChart>
              <Pie
                data={outbreakData}
      ...
      {/* District-wise Data */}
      <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">District-wise Statistics</h3>
  ...
  const renderHospitalRequests = () => (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h3 className="text-xl font-bold text-gray-900 dark:text-white">Hospital Registration Requests</h3>
          ...
          >
            <div className="p-6">
              <div className="flex items-start justify-between mb-4">
                <div>
                  <h4 className="text-lg font-semibold text-gray-900 dark:text-white">{request.hospitalName}</h4>
                  <p className="text-gray-600 dark:text-gray-400">{request.contactPerson}</p>
                </div>
              ...
              <div className="mb-4">
                <p className="text-sm font-medium text-gray-900 dark:text-white mb-2">Specialties:</p>
                <div className="flex flex-wrap gap-1">
                  {request.specialties.map((specialty, index) => (
                    <span key={index} className="px-2 py-1 bg-blue-100 dark:bg-blue-900/20 text-blue-700 dark:text-blue-400 text-xs rounded-full">
                      {specialty}
                    </span>
                  ))}
                </div>
              ...
              <div className="flex space-x-2">
                <button
                  ...
                  className="flex-1 bg-green-600 text-white py-2 px-4 rounded-lg hover:bg-green-700 smooth-transition flex items-center justify-center space-x-2"
                >
                ...
                <button
                  ...
                  className="flex-1 bg-red-600 text-white py-2 px-4 rounded-lg hover:bg-red-700 smooth-transition flex items-center justify-center space-x-2"
                >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400">Manage the Aarogyam health system</p>
            </div>
            <div className="flex items-center space-x-4">
        ...
        >
          ...
          {activeTab === 'migrants' && (
            <div className="text-center py-12">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Migrants Management</h3>
          ...
          {activeTab === 'outbreaks' && (
            <div className="text-center py-12">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Outbreak Management</h3>
              <p className="text-gray-600 dark:text-gray-400">Coming soon...</p>
            </div>
          )}
          {activeTab === 'settings' && (
